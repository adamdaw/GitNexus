...
This project is indexed by GitNexus as **GitNexus** (18926 symbols, 51197 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
